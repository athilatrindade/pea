...
def cadastrar_testober(request, modalidade_id, atleta_id, teste_id):
    ...
    return render(request, 'cadastrar_testober.html', {'atleta':atleta, 'atletas':atletas, 'instrutores':instrutores, 'status':status, 'instrutor_relacionado':instrutor_relacionado, 'teste_id':teste_id, 'modalidade_id':modalidade_id})


def valida_testober(request, modalidade_id, atleta_id, teste_id):
    ...
    try:
        ...
        testober = Testober(direito = direito, esquerdo = esquerdo, teste = teste)
        testober.save()
...
def home_testober(request, modalidade_id, atleta_id, teste_id):
    ...
    return render(request, 'home_testober.html', {'atleta':atleta, 'atletas':atletas, 'instrutores':instrutores, 'status':status, 'instrutor_relacionado':instrutor_relacionado, 'teste_id':teste_id, 'modalidade_id':modalidade_id, 'avaliacao2_url':avaliacao2_url})
